...
js/js.min.js: js/script.js js/jquery.cookie.js
	@echo "================================"
	@echo "[JS] Starting minification"
	# $(YUICOMPRESSOR) -o js/js.min.js js/js.tmp.js
	$(CLOSURE) --js js/jquery.cookie.js --js js/script.js --create_source_map js/js.min.js.map --source_map_format=V3 --js_output_file js/js.min.js
